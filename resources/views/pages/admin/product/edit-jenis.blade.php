    ...
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms" method="post" action="{{ route('jenis.update', $data->id) }}">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('jenis') is-invalid @enderror" id="jenis"
                ...
                value="{{ $data->jenis ? $data->jenis : old('jenis') }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('ukuran') is-invalid @enderror" id="ukuran"
                ...
                value="{{ $data->ukuran ? $data->ukuran : old('ukuran') }}">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga"
                ...
                value="{{ $data->harga ? $data->harga : old('harga') }}">
