  ...
  <div class="sidebar-body">
    <ul class="nav">
            ...
            <ul class="nav sub-menu">
              ...
              <li class="nav-item">
                <a href="{{ route('tracking.create') }}"
                  class="nav-link {{ active_class(['tracking/create']) }}">Tambah
                  Tracking Product</a>
              </li>
            </ul>
          </div>
      ...
      @elseif (Auth::user()->role_id == 2)
        <li class="nav-item nav-category">Pimpinan</li>
        <li class="nav-item {{ active_class(['/']) }}">
          <a href="{{ url('/dashboard') }}" class="nav-link">
            <i class="link-icon" data-feather="box"></i>
            <span class="link-title">Dashboard</span>
      ...
      @elseif (Auth::user()->role_id == 3)
        <li class="nav-item nav-category">Pelanggan</li>
        <li class="nav-item {{ active_class(['/']) }}">
          <a href="{{ url('/dashboard') }}" class="nav-link">
            <i class="link-icon" data-feather="box"></i>
            <span class="link-title">Dashboard</span>
        ...
        <li class="nav-item {{ active_class(['/']) }}">
          <a href="{{ url('/dashboard') }}" class="nav-link">
            ...
            <span class="link-title">Buat Pesanan</span>
          </a>
        </li>
        <li class="nav-item {{ active_class(['/']) }}">
          <a href="{{ url('/dashboard') }}" class="nav-link">
